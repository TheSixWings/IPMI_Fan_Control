...
class UIA_SelectionItemPattern extends UIA_Base {
	; https://docs.microsoft.com/en-us/windows/win32/api/uiautomationclient/nn-uiautomationclient-iuiautomationselectionitempattern
	static __IID := "{a8efa66a-0fda-421a-9194-38021f3578ea}", __PatternID := 10010, __Properties := "CurrentIsSelected,6,BOOL"
	Select() {
		return UIA_Hr(DllCall(this.__Vt(3), "ptr",this.__Value))
	}
}
...
class UIA_ValuePattern extends UIA_Base {
	...
	static __IID := "{59213f4f-7346-49e5-b120-80555987a148}", __PatternID := 10002, __Properties := "CurrentValue,4,double`r`nCurrentIsReadOnly,5,BOOL"
	SetValue(val) {
		return UIA_Hr(DllCall(this.__Vt(3), "ptr",this.__Value, "double",val))
	}
	GetCurrentValue() { ; need to release BSTR?
		return UIA_Hr(DllCall(this.__Vt(4), "ptr",this.__Value, "ptr*",value))? StrGet(value):
	}
}

; class UIA_TextPattern extends UIA_Base {
; 	; https://docs.microsoft.com/en-us/windows/win32/api/uiautomationclient/nn-uiautomationclient-iuiautomationtextpattern
; 	static __IID := "{32eba289-3583-42c9-9c59-3b6d9a1e9b6a}", __PatternID := 10014, __Properties := "DocumentRange,7,**range"
; 	GetDocumentRange() {
; 		return UIA_Hr(DllCall(this.__Vt(7), "ptr",this.__Value, "ptr*",out))? ComObj(0x4000,out,1):
; 	}
; }
